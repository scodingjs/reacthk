...
const Header =() => {
 return(
  ...
  <nav className="bg-slate-900 decoration-orange-600 fixed w-full top-0 border-b border-gray-20">
    <div className="max-w-screen-xl flex flex-wrap items-center 0justify-between mx-auto p-4">
    <a href="https://flowbite.com/" className="flex items-center space-x-3 rtl:space-x-reverse">
        {/* <img src="https://flowbite.com/docs/images/logo.svg" className="h-8" alt="Flowbite Logo"/> */}
        <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Sk</span>
    </a>
